YUI.add("yuidoc-meta", function(Y) {
   Y.YUIDoc = { meta: {
    "classes": [
        ...
        "Dom",
        "Editor",
        "EditorPlugin.BackColor",
        "EditorPlugin.Bold",
        "EditorPlugin.CheckBoxSourceArea",
        "EditorPlugin.Code",
        "EditorPlugin.Draft",
        "EditorPlugin.DragUpload",
        "EditorPlugin.EditorResize",
        "EditorPlugin.ElementPath",
        "EditorPlugin.Flash",
        "EditorPlugin.FontColor",
        "EditorPlugin.FontFamily",
        "EditorPlugin.FontSize",
        "EditorPlugin.Heading",
        "EditorPlugin.Image",
        "EditorPlugin.Indent",
        "EditorPlugin.Italic",
        "EditorPlugin.JustifyCenter",
        "EditorPlugin.JustifyLeft",
        "EditorPlugin.JustifyRight",
        "EditorPlugin.Link",
        "EditorPlugin.Maximize",
        "EditorPlugin.MultipleUpload",
        "EditorPlugin.OrderedList",
        "EditorPlugin.Outdent",
        "EditorPlugin.PageBreak",
        "EditorPlugin.Preview",
        "EditorPlugin.RemoveFormat",
        "EditorPlugin.Separator",
        "EditorPlugin.Smiley",
        "EditorPlugin.SourceArea",
        "EditorPlugin.StrikeThrough",
        "EditorPlugin.Table",
        "EditorPlugin.Underline",
        "EditorPlugin.Undo",
        "EditorPlugin.UnorderedList",
        "EditorPlugin.Video",
        "EditorPlugin.XiaMiMusic",
        "Event",
        "Event.Target",
        "Feature",
        "FilterMenu",
