...
* @param [config.queue=undefined] {String|false|undefined} 所属队列名称. 默认undefined. 属于系统内置队列, 设置 false 则表示该动画不排队立即执行
* @param [config.complete] {Function} 动画到最后一帧后的回调函数
* @param [config.useTransition=false] {Boolean} 是否使用css3 transition提升性能。
