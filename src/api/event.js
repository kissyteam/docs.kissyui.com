...
__这里有三个demo供参考理解__
1. [委托实现点击通知](5.0/examples/event/delegate.html)
2. [阻止事件向上冒泡](5.0/examples/event/delegate_2.html)
3. [委托 mouseenter/mouseleave](5.0/examples/event/delegate_3.html)
*/
...
@example
这里有个[demo](5.0/examples/event/fire.html),点击第二个按钮手动触发第一个按钮的点击, 简便起见使用node模块提供的接口.
*/
...
@event focusin
@example
[监听 form 中输入域的聚焦情况](5.0/examples/event/focusin.html)
*/ 
...
@event focusout
@example
[监听 form 中输入域的聚焦情况](5.0/examples/event/focusout.html)
*/ 
...
```
[hash 驱动的单页面应用设计](5.0/examples/event/hashchange.html)
*/
...
```
[打开拼音输入法，输入时直接鼠标选词demo](5.0/examples/event/valuechange.html)
*/
...
@event mousewheel
@example
[demo](5.0/examples/event/mousewheel.html)
*/
...
@event doubleTap
@example
需要在移动设备上面打开：[demo](5.0/examples/event/double-tap.html)
*/
...
@event singleTap
@example
需要在移动设备上面打开：[demo](5.0/examples/event/singel-tap.html)
```
<!doctype html>
<html>
<head>
...
@event tap
@example
需要在移动设备上面打开：[demo](5.0/examples/event/tap.html)
```
...
@event shake
@example
需要在移动设备上面打开：[demo](5.0/examples/event/shake.html)
```
 var S = KISSY;
